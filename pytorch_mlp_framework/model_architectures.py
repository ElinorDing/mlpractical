...
class ConvolutionalProcessingBlock_BNRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_BNRC, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_BNRC(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_BNRC, self).__init__()
