...
elif args.block_type == 'conv_block_bnrc':
    processing_block_type = ConvolutionalProcessingBlock_BNRC
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock_BNRC
